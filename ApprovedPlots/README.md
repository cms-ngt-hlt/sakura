...
![time variations of physics performance on varying conditions demonstrated on Z peak fit](./dCal_dt-ECAL/screenshot_stability_comparison_sigma_over_mu.png)
