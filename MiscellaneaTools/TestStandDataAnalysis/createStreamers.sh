...
mkdir -p prepared
cat run392642/run392642_ls0000_streamLocalTestDataRaw_pid3827182.ini run392642/run392642_ls0174_streamLocalTestDataRaw_pid3827182.dat > prepared/run392642_ls0174_streamLocalTestDataRaw_pid3827182.dat

# run the FRD conversion
#cmsRun convertStreamerToFRD.py filePrepend=file: inputFiles=run392642_ls0174_streamLocalTestDataRaw_pid3827182.dat # NOTE: uncomment to immediately run the conversion to FRD (.raw)
